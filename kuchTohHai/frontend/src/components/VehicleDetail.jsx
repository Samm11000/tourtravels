...
//   if (!vehicle) {
//     return <p className="text-center text-gray-600 py-10">Vehicle not found</p>;
//   }
...
//                 </div>
//                 <div className="absolute top-4 left-4 bg-white bg-opacity-90 text-gray-800 px-3 py-2 rounded-full flex items-center">
...
//                     <p className="text-gray-600">{vehicle.seatingCapacity}</p>
//                   </div>
//                 </div>
//                 <div className="flex items-center">
...
//                   <div>
//                     <p className="font-medium text-gray-900">Transmission</p>
...
//                   {t("mileage")}
//                 </h3>
//                 <p className="text-gray-700">{vehicle.mileage}</p>
//               </div>
...
//                     <span className="text-gray-600">Local/Hourly:</span>
