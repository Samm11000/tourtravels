...
//   return (
//     <section id="testimonials" className="py-20 bg-gradient-to-b from-yellow-50 to-amber-50">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="text-center mb-16">
//           <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('whatCustomersSay')}</h2>
...
//         <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
//           {testimonials.map(testimonial => (
//             <div key={testimonial.id} className="bg-white rounded-2xl p-6 hover:shadow-lg transition-all transform hover:-translate-y-1 border border-amber-100 shadow-md">
//               <div className="flex items-center mb-4">
//                 <img 
//                   src={testimonial.image} 
//                   alt={testimonial.name}
...
//               <div className="relative">
//                 <Quote className="w-6 h-6 text-amber-200 absolute -top-2 -left-1" />
//                 <p className="text-gray-700 text-sm leading-relaxed pl-4">
//                   {testimonial.comment}
//                 </p>
//               </div>
...
//         <div className="bg-gradient-to-r from-amber-600 to-yellow-600 rounded-2xl p-12 text-center text-white shadow-xl">
//           <h3 className="text-3xl font-bold mb-4">{t('joinHappyCustomers')}</h3>
...
//           <a 
//             href="tel:+919368084778" 
//             className="bg-white text-amber-600 px-8 py-4 rounded-xl hover:bg-amber-50 transition-all transform hover:scale-105 font-semibold inline-flex items-center shadow-lg group"
//           >
//             {t('bookNow')}
//             <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
//           </a>
