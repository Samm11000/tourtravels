...
// const Enquiries = ({ onSelectEnquiry }) => {
...
//                 <p className="text-3xl font-bold text-gray-900">
//                   {enquiries.filter(e => e.serviceType.toLowerCase() === 'airport').length}
//                 </p>
//               </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-sm font-medium text-gray-600">Outstation Trips</p>
//                 <p className="text-3xl font-bold text-gray-900">
