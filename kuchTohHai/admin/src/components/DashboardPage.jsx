...
//                   Toyota Camry 2024 - 2 minutes ago
//                 </p>
//               </div>
//             </div>
//             <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
...
//                 </p>
//                 <p className="text-gray-600 text-sm">
//                   Rental package inquiry - 5 minutes ago
//                 </p>
//               </div>
//             </div>
//             <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
...
//               <div className="flex-1">
//                 <p className="text-gray-900 font-medium">Package updated</p>
//                 <p className="text-gray-600 text-sm">
//                   Premium package pricing - 12 minutes ago
//                 </p>
//               </div>
//             </div>
//           </div>
